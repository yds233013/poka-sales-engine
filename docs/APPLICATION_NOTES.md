...
- Designed deterministic engines, a grounding layer and server-enforced human approvals so the
  model cannot invent prices, stock or technical claims. Verified with 393 tests, a 14-scenario live
...
- **Offline tests:** 393 (267 unit, 126 integration against a real seeded Postgres).
